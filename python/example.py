...
# This assumes fvdb module is installed or the bindings are built
try:
    from fvdb import VectorDB
except ImportError:
    print("Please install fvdb first: pip install fvdb")
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"Top 10 results for cosine metric:")
        ...
        batch_queries = batch_queries / (np.linalg.norm(batch_queries, axis=1, keepdims=True) + 1e-8)
